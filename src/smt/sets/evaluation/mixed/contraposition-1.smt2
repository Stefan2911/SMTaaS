...
(assert (not (models empty (forallR_alpha v0_alpha (forallR_alpha (next_alpha v0_alpha) (orR (notR (orR (notR (orR (notR (pR (inj_alpha v0_alpha))) (qR (inj_alpha (next_alpha v0_alpha))))) (notR (orR (notR (notR (qR (inj_alpha (next_alpha v0_alpha))))) (notR (pR (inj_alpha v0_alpha))))))) (notR (orR (notR (notR (orR (notR (pR (inj_alpha v0_alpha))) (qR (inj_alpha (next_alpha v0_alpha)))))) (notR (notR (orR (notR (notR (qR (inj_alpha (next_alpha v0_alpha))))) (notR (pR (inj_alpha v0_alpha))))))))))))))
(check-sat)
(exit)
